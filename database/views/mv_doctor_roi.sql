...
rx as (
    select
        ...
        max(territory_name) filter (where territory_name is not null) as territory_name,
...
metrics as (
    select
        ...
        coalesce(d.territory_name, rx.territory_name) as territory_name,
        d.territory_id,
        (d.doctor_master_source_file_id is not null) as has_doctor_master,
