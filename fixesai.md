1) text should be formatted properly, gemini returns markdown but the code comes like for bold - ** comes in the text
2) context, content accuracy checking
3) limiting behaviour and context
