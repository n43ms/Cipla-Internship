...
CONSOLIDATION_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "req_id": ("REQ_ID", "Request ID", "Req ID", "Intervention No", "Intervention No."),
        "month": ("Months", "Month"),
...
RCPA_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "territory_name": ("Location", "Territory"),
        "patch_name": ("Patch", "Patch Name", "PATCHNAME"),
        "pcode_mapping_method": (
            "pcode_mapping_method",
            "Pcode Mapping Method",
            "P-code Mapping Method",
            "Mapping Method",
        ),
    },
)

MSL_DOCTOR_MASTER_SCHEMA = SourceSchema(
    source_type="msl_doctor_master",
    canonical_sheet_names=("MSL", "Doctor Master", "Sheet1"),
    required={"country", "pcode", "doctor_name", "territory_name"},
    aliases={
        "country": ("BU", "Country", "Division"),
        "pcode": ("Pcode", "P Code", "PCODE"),
        "doctor_name": ("Doctor Name", "Doctor", "Dr Name"),
        "doctor_short_name": ("DrSname", "Doctor Short Name", "Short Name"),
        "territory_name": ("Location", "Territory"),
        "territory_id": ("Territory Id", "Territory ID", "Territory Code"),
        "patch": ("Patch", "Patch Name"),
        "patch_name": ("Patchsname", "Patch Name", "PATCHNAME"),
        "legacy_code": ("Legacy Code", "LegacyCode"),
        "speciality": ("Speciality", "Specialty", "Speciality/Prac", "Speciality/Qual"),
        "doctor_class": ("Class", "Doctor Class", "Category"),
        "taskforce": ("Taskforce", "Task Force"),
        "rep_name": ("Repname", "Rep Name"),
        "rep_code": ("REPCODE", "Rep Code"),
        "employee_id": ("Employee ID", "Employee Id"),
        "manager_name": ("Manager Name",),
        "town": ("Town",),
        "cis_no": ("CIS No", "CIS Number"),
        "registration_no": ("Reg No", "Registration No"),
        "gender": ("Gender",),
    },
)

ERS_CONFERENCE_SCHEMA = SourceSchema(
    source_type="ers_conference",
    canonical_sheet_names=("ERS", "Sheet1"),
    required={"country", "month", "intervention_id", "doctor_name"},
    aliases={
        "intervention_id": ("Event Code", "Event ID", "Intervention ID"),
        "country": ("BU", "Country", "Division"),
        "month": ("Month", "Months"),
        "therapy": ("Therapy",),
        "therapy_detail": ("Therapy Detailed", "Therapy Detail"),
        "intervention_type": ("Type of Event", "Event Type", "Intervention Type"),
        "intervention_name": ("Name of the Event", "Event Name", "Intervention Name"),
        "doctor_name": ("Doctor Name", "Dr Name"),
        "speciality": ("HCP Speciality", "Speciality", "Specialty"),
        "count": ("Count",),
        "honorarium_local": ("Honorarium",),
        "honorarium_usd": ("USD", "Amount USD", "Honorarium USD"),
        "concat": ("Concat",),
    },
)
...
DOCTOR_CONTRACT_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "expected_intervention_date": ("Expected Intervention date", "Expected Intervention Date"),
        ...
        "doctor_name": ("Doctor Name", "Dr Name"),
        "estimated_intervention_amount": ("Estimated Intervention Amount",),
        "btu_expense": ("BTU Expense",),
        "expense_against_advance": ("Expense Against Advance",),
        "btc_expense": ("BTC Expense",),
        "total_actual_intervention_expense": ("Total Actual intervention Exp Amt",),
        "fmv_speciality": ("FMV Speciality",),
        "fmv_tier": ("FMV Tier",),
        "fmv_role": ("FMV Role",),
...
SCHEMAS = {
    ...
    "rcpa": RCPA_SCHEMA,
    "msl_doctor_master": MSL_DOCTOR_MASTER_SCHEMA,
    "ers_conference": ERS_CONFERENCE_SCHEMA,
