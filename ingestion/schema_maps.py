...
PLANNER_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "planned_total_hcps": ("# Total Planned Docs", "# Total Planned Docs (A+X)", "Total Planned Docs", "Planned HCPs"),
        ...
        "planned_patients": ("# Total No. of Patient's (If any)", "Total No. of Patient's (If any)", "Planned Patients", "# Patients"),
        ...
        "total_honorarium_cost_usd": ("Total Honorarium Cost (USD) (A*B)", "Total Honorarium Cost USD", "Total Honorarium Cost"),
...
EXECUTION_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "engaged_hcps": ("Approved Doctors", "Engaged HCPs", "HCP's Engaged count", "Approved Total Doctors", "Approved Total Drs"),
        ...
        "approved_total_doctors": ("Approved Total Doctors", "Approved Total Drs", "Approved Doctors"),
        "request_total_doctors": ("Request Total Doctors", "Request Total Drs", "Requested Doctors"),
...
CONSOLIDATION_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "association_contract_id": ("Association Contract ID", "Association Agreement ID", "Contract ID"),
        "association_deliverables": ("Association Deliverables", "Deliverables"),
        "expected_customer_count": ("NUMBER OF CUSTOMER EXPECTED TO ATTEND", "Expected Customer Count", "Expected Customers", "No. of Expected Customers"),
        "attended_customer_count": ("DOCTORS ATTENDED INTERVENTION", "Attended Customer Count", "Attended Customers", "No. of Attended Customers"),
        "expected_category_raw": ("DR.CATEGORY EXPECTED TO ATTEND", "Expected Category", "Expected Customer Category"),
        "attended_category_raw": ("DR.CATEGORY ATTENDED THE INTERVENTION", "Attended Category", "Attended Customer Category"),
        ...
        "request_approval_status": ("PENDING FOR APPROVAL Request", "Request Approval Status", "APPROVAL STATUS"),
        "request_confirmation_status": ("PENDING FOR CONFIRMATION Request", "Request Confirmation Status", "Confirmation Status"),
        "post_approval_status": ("PENDING FOR APPROVAL POST", "Post Approval Status", "Post Event Approval Status"),
        "post_confirmation_status": ("PENDING FOR CONFIRMATION POST", "Post Confirmation Status", "Post Event Confirmation Status"),
