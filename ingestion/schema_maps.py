...
PLANNER_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "planned_honorarium_hcps": ("Honorarium HCPs", "Honorarium Docs", "# Honorarium HCPs"),
        "planned_delegate_hcps": ("Delegate HCPs", "Delegate Docs", "# Delegate HCPs"),
        ...
        "honorarium_cost_per_hcp_usd": ("Honorarium Cost/HCP USD", "Honorarium Cost per HCP USD"),
        "total_honorarium_cost_usd": ("Total Honorarium Cost USD", "Total Honorarium Cost"),
        "operational_cost_per_unit_usd": ("Operational Cost/Unit USD", "Operational Cost per Unit USD"),
        "total_operational_cost_usd": ("Total Operational Cost USD", "Total Operational Cost"),
...
EXECUTION_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "yp_total_doctors": ("YP Total Doctors", "YP Doctors"),
        "raised_total_doctors": ("Raised Total Doctors", "Raised Doctors"),
        "approved_total_doctors": ("Approved Total Doctors", "Approved Doctors"),
        "request_total_doctors": ("Request Total Doctors", "Requested Doctors"),
...
CONSOLIDATION_SCHEMA = SourceSchema(
    ...
    aliases={
        ...
        "expected_customer_count": ("Expected Customer Count", "Expected Customers", "No. of Expected Customers"),
        "attended_customer_count": ("Attended Customer Count", "Attended Customers", "No. of Attended Customers"),
        "expected_category_raw": ("Expected Category", "Expected Customer Category"),
        "attended_category_raw": ("Attended Category", "Attended Customer Category"),
