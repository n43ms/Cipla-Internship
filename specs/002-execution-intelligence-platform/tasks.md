...
- [ ] T123 [US3] Create migration to install budget materialized view, monetary indexes, and financial mapping constraints in `database/migrations/versions/0012_budget_finance_view.py`
...
- [ ] T142 [US4] Create migration to install doctor ROI materialized view, doctor indexes, and quadrant indexes in `database/migrations/versions/0013_doctor_roi_quadrant_view.py`
...
- [ ] T156 [US5] Create migration to install data quality materialized view and indexes in `database/migrations/versions/0014_data_quality_view.py`
